                    ...
                    <ul style="display: flex; align-items: center" class="navbar-nav ms-auto">
                        ...
                        <a style="color: white;" id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre><svg width="40" height="40" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href=""> <!--ruta para login-->
                                Inicia sesión</a>
                                <a class="dropdown-item" href=""><!--ruta para registro-->
                                Regístrate</a> -->
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="" onclick="event.preventDefault(); 
                                                    document.getElementById('logout-form').submit();"><!--ruta para logout-->
                                    {{ __('Logout') }}
                                </a>

                                <form id="logout-form" action="" method="POST" class="d-none"><!--en action ruta para logout-->
                                    @csrf
                                </form>
                            </div>
                        </li>
                        ...
                        @if (Auth::check())
                        <li>
                            <a style="display: flex; flex-direction: column; color: white; align-items: center; text-decoration: none; margin-right: 0.5vw; margin-left: 0.5vw" href=""><!--ruta para registro-->
                        ...
                        @if (Auth::check() && Auth::user()->isAdmin))
                            <li>
                        <a style="display: flex; flex-direction: column; color: white; align-items: center; text-decoration: none; margin-right: 0.5vw; margin-left: 0.5vw" class="nav-link" href=""><!--ruta para crear-->
                ...
                <a href="#!">
                    <div class="absolute right-0 bottom-0 left-0 w-full h-20 overflow-hidden bg-fixed" style="background-color: rgba(8, 3, 21, 0.61)">
                        ...
                        <div class="flex justify-items-start align-bottom items-end h-full">
                            ...
                            <button>♥️</button>
                            <form action="{{ route('remove', ['id' => $photo->id]) }}" method="get">
